  ...
  return (
    <main className="min-h-screen overflow-hidden bg-slate-950 text-white">
      ...
      <div className="relative mx-auto min-h-screen w-full max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
        <header className="growth-rise sticky top-4 z-20 rounded-2xl border border-white/10 bg-slate-950/76 px-4 py-3 shadow-2xl shadow-black/25 backdrop-blur-xl">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            >
              ...
              <Link
                ...
                className="active-pulse rounded-full border border-teal-300/30 bg-teal-300/12 px-4 py-2 text-teal-100 transition hover:bg-teal-300/16 hover:text-white"
              >
                Growth
              </Link>
              <Link
        ...
        <section className="growth-rise py-10 sm:py-12">
        ...
        <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          {statCards.map((card, index) => (
            ...
            >
              ...
              <p className="mt-4 text-4xl font-semibold tracking-normal text-white">
                {card.value}
              </p>
        ...
        <section className="growth-rise mt-6 rounded-[1.75rem] border border-white/10 bg-white/[0.05] p-5 shadow-2xl shadow-black/20 backdrop-blur-md">
          ...
          <div className="mt-6 overflow-x-auto pb-2">
            <div
              className="grid min-w-[760px] items-end gap-3"
              style={{
        ...
        <section className="growth-rise mt-6 rounded-[1.75rem] border border-white/10 bg-slate-900/72 p-5 shadow-2xl shadow-black/20 backdrop-blur-md">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div>
          ...
          {streakMode === "date" ? (
            ...
            <div className="mt-6 grid gap-2 sm:grid-cols-6 lg:grid-cols-12">
        ...
        <section className="growth-rise mt-6 grid gap-5 pb-10 lg:grid-cols-[0.82fr_1.18fr]">
          <aside className="rounded-[1.75rem] border border-white/10 bg-white/[0.045] p-5 shadow-2xl shadow-black/20 backdrop-blur-md">
          ...
          <section className="rounded-[1.75rem] border border-white/10 bg-white/[0.05] p-5 shadow-2xl shadow-black/20 backdrop-blur-md">
            ...
            <div className="mt-5 divide-y divide-white/10">
              {suggestions.map((suggestion, index) => (
                ...
                >
                  <span
                    className={`inline-flex rounded-full border px-3 py-1 text-xs font-semibold ${suggestionAccentClass(
                      suggestion.accent,
                    )}`}
                  >
                    {suggestion.title}
