  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-slate-950 text-white">
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-7xl flex-col px-3 py-3 sm:px-6 sm:py-4 lg:px-8">
        <header className="profile-rise sticky top-2 z-20 rounded-2xl border border-white/10 bg-slate-950/72 px-3 py-3 shadow-2xl shadow-black/25 backdrop-blur-xl sm:top-4 sm:px-4">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <Link href={studyHref} className="text-lg font-semibold tracking-normal sm:text-xl">
              Crack AI
            </Link>
        ...
        <section className="profile-rise grid flex-1 items-center gap-5 py-6 sm:gap-6 sm:py-8 lg:grid-cols-[0.78fr_1.22fr] lg:py-12">
          <aside className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/[0.055] p-5 shadow-2xl shadow-black/25 backdrop-blur-md sm:rounded-[1.75rem] sm:p-6">
            <div className="profile-glow absolute -right-16 -top-16 h-48 w-48 rounded-full bg-teal-300/20 blur-3xl" />

            <div className="relative flex flex-col items-center text-center">
              <div className="relative">
                <div className="flex h-28 w-28 items-center justify-center overflow-hidden rounded-[1.5rem] border border-white/15 bg-slate-950 shadow-[0_30px_90px_rgba(0,0,0,0.45)] sm:h-36 sm:w-36 sm:rounded-[2rem]">
                  {avatarUrl ? (
                    <img
                      src={avatarUrl}
              ...
              <h1 className="mt-8 text-2xl font-semibold tracking-normal sm:text-3xl">
                {displayName}
              </h1>
              <p className="mt-2 max-w-full break-all text-sm text-slate-300">
                {accountEmail}
              </p>
          ...
          <div className="grid gap-5">
            ...
            <section className="profile-rise rounded-2xl border border-white/10 bg-slate-900/72 p-4 shadow-2xl shadow-black/20 backdrop-blur-md sm:rounded-[1.75rem] sm:p-6">
              ...
              <div className="mt-5 grid gap-4 md:grid-cols-3">
                ...
                <div className="rounded-2xl border border-white/10 bg-white/[0.045] p-5 [container-type:inline-size]">
                  ...
                  <p
                    className="mt-3 max-w-full break-all font-semibold leading-6 text-slate-200 sm:whitespace-nowrap"
            ...
            <section className="profile-rise flex flex-col gap-3 rounded-2xl border border-white/10 bg-slate-900/72 p-4 shadow-2xl shadow-black/20 backdrop-blur-md sm:flex-row sm:items-center sm:justify-between sm:rounded-[1.75rem] sm:p-5">
              <div>
      ...
      {supportOpen ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/78 px-3 py-3 backdrop-blur-sm sm:px-4 sm:py-6">
          <div className="profile-rise max-h-[calc(100svh-1.5rem)] w-full max-w-lg overflow-y-auto rounded-2xl border border-white/10 bg-slate-900 p-4 shadow-2xl shadow-black/35 sm:rounded-[1.5rem] sm:p-5">
