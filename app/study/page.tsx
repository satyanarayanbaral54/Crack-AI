  ...
  return (
    <main className="min-h-screen overflow-hidden bg-slate-950 text-white">
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-7xl flex-col px-4 py-4 sm:px-6 lg:px-8">
        ...
        <section className="dashboard-rise mb-10 rounded-[1.75rem] border border-white/10 bg-white/[0.04] p-5 shadow-2xl shadow-black/20 backdrop-blur-md">
        ...
        <section className="dashboard-rise mb-10 overflow-hidden rounded-[1.75rem] border border-white/10 bg-slate-900/72 p-5 shadow-2xl shadow-black/20 backdrop-blur-md">
      ...
      {mockRulesOpen && mockConfig ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/82 px-4 py-6 backdrop-blur-sm">
          <section className="mock-panel-in max-h-[92vh] w-full max-w-3xl overflow-y-auto rounded-[1.5rem] border border-white/10 bg-slate-900 p-5 shadow-2xl shadow-black/40">
      ...
      {mockTestOpen && mockConfig ? (
        <div className="fixed inset-0 z-50 bg-slate-950/92 px-3 py-3 backdrop-blur-md sm:px-6 sm:py-6">
          <section className="mock-panel-in mx-auto flex h-full max-w-7xl flex-col overflow-hidden rounded-[1.5rem] border border-white/10 bg-slate-900 shadow-2xl shadow-black/45">
            <header className="flex flex-col gap-4 border-b border-white/10 px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
              ...
              <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
                <span className="mock-timer-pulse inline-flex h-11 items-center justify-center rounded-xl border border-amber-300/30 bg-amber-300/10 px-4 text-sm font-bold text-amber-100">
                ...
                <button
                  ...
                  className="inline-flex h-11 items-center justify-center rounded-xl bg-white px-4 text-sm font-semibold text-slate-950 transition hover:bg-amber-100 focus:outline-none focus:ring-4 focus:ring-white/20"
                >
            ...
            {mockSubmitted ? (
              ...
              <div className="grid min-h-0 flex-1 gap-0 lg:grid-cols-[1fr_19rem]">
                        ...
                        {currentMockQuestion.options.map((option, optionIndex) => {
                          ...
                          return (
                            <button
                              ...
                              className={`rounded-2xl border px-4 py-4 text-left text-sm font-medium leading-6 transition hover:-translate-y-0.5 focus:outline-none focus:ring-4 focus:ring-teal-300/20 ${
                                isSelected
          ...
          {mockSubmitted && mockSuggestionOpen ? (
            <div className="absolute inset-0 z-10 flex items-center justify-center bg-slate-950/55 px-4 py-6 backdrop-blur-sm">
              <section className="mock-panel-in w-full max-w-lg rounded-[1.5rem] border border-teal-300/20 bg-slate-900 p-5 shadow-2xl shadow-black/40">
                <p className="text-xs font-semibold uppercase tracking-[0.22em] text-teal-300">
                  AI suggestion
                </p>
                <h3 className="mt-3 text-2xl font-semibold text-white">
