...
export default function DashboardPage() {
  ...
  return (
    <main className="flex min-h-svh items-start justify-center bg-slate-100 px-3 py-4 text-slate-950 dark:bg-slate-950 dark:text-white sm:items-center sm:px-6 sm:py-8">
      <section className="w-[calc(100vw-1.5rem)] max-w-6xl rounded-2xl border border-white/70 bg-white p-4 shadow-glow dark:border-white/10 dark:bg-slate-900 sm:w-full sm:rounded-[1.5rem] sm:p-8">
