  ...
  return (
    <main className="min-h-screen overflow-hidden bg-slate-950 text-white">
      ...
      <div className="relative mx-auto min-h-screen w-full max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
        <header className="syllabus-rise sticky top-4 z-20 rounded-2xl border border-white/10 bg-slate-950/76 px-4 py-3 shadow-2xl shadow-black/25 backdrop-blur-xl">
        ...
        <section className="syllabus-rise py-12 sm:py-14">
        ...
        <section className="grid gap-6 pb-10 lg:grid-cols-[0.95fr_1.05fr]">
                  ...
                  {section.topics.map((topic) => {
                    ...
                    return (
                      <button
                        ...
                        className={`group flex w-full items-center justify-between gap-4 rounded-xl border px-4 py-3 text-left transition hover:-translate-y-0.5 focus:outline-none focus:ring-4 focus:ring-teal-300/20 ${
                          isActive
          ...
          <aside className="lg:sticky lg:top-28 lg:self-start">
            <div
              ...
              className="topic-detail rounded-[1.75rem] border border-white/10 bg-slate-900/78 p-6 shadow-2xl shadow-black/25 backdrop-blur-xl"
            >
              ...
              <div className="mt-7">
                ...
                <ul className="mt-4 space-y-3">
                  {selectedTopic.highlights.map((highlight, index) => (
                    <li
                      key={highlight}
                      className="flex gap-3 rounded-xl border border-white/8 bg-slate-950/38 px-4 py-3"
                    >
