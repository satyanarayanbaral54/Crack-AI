...
export function AiVoiceTutor({
  ...
  return (
    <>
      ...
      {open ? (
        <section className="voice-tutor-panel fixed inset-x-3 bottom-24 z-50 max-h-[calc(100svh-7rem)] overflow-y-auto rounded-2xl border border-white/70 bg-white/95 p-4 shadow-2xl shadow-slate-900/20 backdrop-blur-xl dark:border-white/10 dark:bg-slate-900/95 dark:shadow-black/30 sm:bottom-28 sm:left-auto sm:right-6 sm:w-[calc(100vw-2rem)] sm:max-w-sm sm:p-5">
      ...
      <button
        ...
        onClick={handleMicClick}
        disabled={answerLoading}
        className={`group fixed bottom-5 right-[5.75rem] z-50 flex h-12 w-12 items-center justify-center rounded-full border shadow-2xl outline-none transition hover:scale-105 focus:ring-4 focus:ring-teal-500/25 disabled:cursor-not-allowed disabled:opacity-70 sm:bottom-9 sm:right-32 sm:h-14 sm:w-14 ${
          listening
      ...
      <button
        ...
        className="group fixed bottom-4 right-4 z-50 flex h-16 w-16 items-center justify-center rounded-full outline-none transition hover:scale-105 focus:ring-4 focus:ring-teal-500/25 sm:bottom-7 sm:right-7 sm:h-20 sm:w-20"
      ...
      >
        ...
        <span className="relative flex h-14 w-14 items-center justify-center rounded-full border border-white/10 bg-slate-950 text-white shadow-inner shadow-white/10 sm:h-[4.2rem] sm:w-[4.2rem]">
