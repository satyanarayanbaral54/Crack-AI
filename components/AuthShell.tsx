          ...
          <div className="relative flex h-full flex-col justify-between">
            <div>
              ...
              <h1 className="mt-8 max-w-xl text-5xl font-semibold leading-tight tracking-normal">
                Auth that feels clean, fast, and ready for real users.
              </h1>
              <p className="mt-6 max-w-md text-base leading-7 text-slate-200">
                Supabase handles the identity layer while your interface keeps
                people oriented from first visit to dashboard.
              </p>
            </div>
